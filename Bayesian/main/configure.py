...
#--- Case name. ---#
#CASENAME = "PR_Ls3_NDRC"
#CASENAME = "PIS_Ls3_4DVar_trad"
CASENAME = "PR_Ls3_4DVar_trad"
#CASENAME = "PIS_Ls3_4DVar_simp"
#CASENAME = "PIS_Ls3_3DVar"
#CASENAME = "PR_Ls3_4DVar_afm"
#CASENAME = "PR_Ls3_4DVar_afm_REAL"
...
ISFREE = False
BASEEXP = "const_emiss"
#BASEEXP = "independent_priorFnet"

#--- Experiment type ("OSSE" or "REAL" currently) ---#
EXPTYPE = "OSSE"

#--- Optimization core ("3DVar" or "4DVar" currently) ---#
CORE = "4DVar" 

#--- Start and end time definition. ---#
START = "2018-11-29_00:00:00" # Start (YYYY-mm-dd_HH:MM:SS)
END = "2019-03-01_00:00:00" # End (YYYY-mm-dd_HH:MM:SS)
DTHRS = 1 # Time interval (unit: hour)

#--- Optimization parameters definition. ---#
WINDOW = 12 # Window of assimilation.
NBACK = 48 # Backward time of STILT model. (unit: hour)

LS = 3 # Spatial length. (unit: km)
...
loc = locals()
exec("from .stations." + FOOTNAME + " import RECEPTORS_DIC")
RECEPTORS_DIC = loc["RECEPTORS_DIC"]
del(loc)
...
FOOTDIR = "/home/tangwh/datasets/STILT_out/receptors"
...
CoreConfig = {
    ...
    "optimize": {
        ...
        "isCompute_dQ": True, # True: traditional method of dQ computing; False: a simple method of dQ computing.
        ...
        "HQHtR_Prefix": "HQHtR",
        "INV_Prefix": "INV",
        "INV_HQ_Prefix": "INV_HQ",
        "HiHQti_Prefix": "HiHQti",
    ...
    "3DVar": {
        #"dt_obs": WINDOW, # Assimilation window (unit: hour), defaulted as same as above.

        #-- Setting of 3DVarWindow iteration option. --#
        ...
        #-- Setting of 3DVar_specific_hour iteration option. --#
    ...
    "4DVar": {
        #"Lt": LT,
        "relevant_length": LT * 3,
        #-- Setting of 4DVarWindow iteration option. --#
        "iteration": "4DVarWindow",
        "iteration_kwargs":
        {
            "dt_obs": WINDOW, 
        },

        #-- Setting of 4DVar_specific_hour iteration option. --#
        #"iteration": "4DVar_specific_hour", # Assimilation iteration method.
        #"iteration_kwargs":
        #{
        #    "hourList": [17],
        #    "UTC": +8,
...
ExpConfig = {
    ...
    "BIS": 
    {
        ...
        "sectors": SECTORS, # Emission sectors definition. (using apython list format)
        "typeToSector_H": {"site" : SECTORS}, # H matrix type -> sector correspondence.
        ### format {"<H type>": ["<sector1>", "<sector2>", ...]}
        "typeToSector_E": {"site" : SECTORS}, # E matrix type -> sector correspondence.
        ### format {"<E type>": ["<sector1>", "<sector2>", ...]}
        "typeToSector_D": {"site" : SECTORS}, # D matrix type -> sector correspondence.
